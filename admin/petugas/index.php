...
<head>
    ...
    <title>Manajemen User - KASIR AZIZ</title>
    ...
    <style>
        * {
        ...
        .stat-card.admin { border-left-color: #f56565; }
        .stat-card.petugas { border-left-color: #4299e1; }
        ...
        .stat-card.total .stat-icon { background: #1e3a8a; }
        .stat-card.admin .stat-icon { background: #f56565; }
        .stat-card.petugas .stat-icon { background: #4299e1; }

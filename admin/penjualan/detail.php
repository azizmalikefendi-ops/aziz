...
<div class="d-flex">
    ...
    <div class="container-fluid p-4">
        ...
        <div class="glass-card col-md-8 mx-auto overflow-hidden">
            <div style="height: 6px; background: linear-gradient(to right, #4facfe, #00f2fe);"></div>
            
            <div class="card-body p-5">
                <div class="nota-header text-center">
                    <h3 class="fw-extrabold mb-1" style="letter-spacing: -1px;">KASIR AZIZ</h3>
                ...
                <div class="d-none d-print-block mt-5 pt-4 border-top text-center text-muted small">
                    Nota dihasilkan secara digital oleh Sistem KASIR AZIZ pada <?= date('d/m/Y H:i:s'); ?>
                </div>
            </div>
        </div>
    </div>

...
<head>
    ...
    <title>Data Pelanggan - KASIR AZIZ</title>
            ...
            <div class="container-fluid">
                ...
                <div class="header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end mt-3 mt-md-0">
                            <button class="btn-add" onclick="window.location.href='tambah.php'">
                ...
                <div class="search-filter-row">
                    ...
                    <div class="filter-pills">
                        ...
                        <div class="filter-pill" onclick="filterCustomers('vip')">VIP</div>
                        <div class="filter-pill" onclick="filterCustomers('regular')">Regular</div>
                    </div>
                </div>
